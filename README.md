...
Atlas handles TTS + lip-sync. You provide text and a face image.
...
Bring your own audio (any TTS provider, or a recording). Atlas does lip-sync only.
...
## Mode 3: ElevenLabs → Video

Generate speech with ElevenLabs, then send the audio to Atlas for lip-sync.
